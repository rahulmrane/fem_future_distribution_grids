...
function initialise_params(mesh)
    ...
    return sourceperelement, reluctivityperelement, conductivityperelement, omega, coil_voltage, ext_resistance, ext_inductance, z_length, time_steps, har_content, har_phase
end
...
sourceperelement, reluctivityperelement, conductivityperelement, omega, coil_voltage, ext_resistance, ext_inductance, z_length, time_steps, har_content, har_phase = initialise_params(mesh)

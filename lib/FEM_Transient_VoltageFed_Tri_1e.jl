module FEM_Transient_VoltageFed_Tri_1e
    ...
    function fem(mesh_data, sourceperelement, reluctivityperelement, conductivityperelement, omega, bnd_node_ids, coil_voltage, ext_resistance, ext_inductance, time_steps, num_harmonic=[1], phase_diff=[0])
    ...
    function fem_nonlinear(mesh_data, sourceperelement, reluctivityperelement, conductivityperelement, omega, bnd_node_ids, coil_voltage, ext_resistance, ext_inductance, time_steps, num_harmonic=[1], phase_diff=[0])
        ## Assemble A, B, and f Matrices

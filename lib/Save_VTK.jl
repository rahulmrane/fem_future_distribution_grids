module Save_VTK
    ...
    function save_vtk(mesh_data, u, B, H, mag_energy, reluctivityperelement, Jel, name)
        mu0 = 4e-7 * pi;
    ...
    function save_vtk(mesh_data, u, B, H, mag_energy, reluctivityperelement, Jel, Pv, name)
        mu0 = 4e-7 * pi;
